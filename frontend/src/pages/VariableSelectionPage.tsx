...
import { AIVariableSuggestions } from '../components/variable-suggestions';
              ...
              <div style={styles.previewPanel}>
                ...
                <div style={styles.previewLegend}>
                  {[
                    ...
                    { label: 'G  Time',      bg: '#fce7f3', border: '#db2777' },
                    { label: 'U  Unit',      bg: '#ffedd5', border: '#ea580c' },
                ...
                <div style={styles.previewTableWrapper}>
                  {!previewData ? (
                    ...
                    const roleOf = (col: string) =>
                      col === selection.outcome ? 'outcome'
                        : col === selection.treatment ? 'treatment'
                        : col === selection.time ? 'time'
                        : col === selection.unit ? 'unit'
                        : selection.controls.includes(col) ? 'control'
                        : 'none';
                    const headerBg: Record<string, string> = {
                      outcome: '#d1fae5', treatment: '#dbeafe', time: '#fce7f3',
                      unit: '#ffedd5', control: '#fef9c3', none: '#f1f5f9',
                    };
                    const headerBorder: Record<string, string> = {
                      outcome: '#059669', treatment: '#2563eb', time: '#db2777',
                      unit: '#ea580c', control: '#ca8a04', none: 'transparent',
                    };
                    const cellBg: Record<string, string> = {
                      outcome: '#f0fdf4', treatment: '#eff6ff', time: '#fdf2f8',
                      unit: '#fff7ed', control: '#fefce8', none: 'transparent',
                    };
                    const roleLabel: Record<string, string> = {
                      outcome: 'Y', treatment: 'T', time: 'G', unit: 'U', control: 'C', none: '',
                    };
                    return (
