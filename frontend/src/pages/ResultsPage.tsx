...
# Install: pip install pandas numpy statsmodels linearmodels matplotlib
              ...
              {showCode && (
                <div style={styles.codeContent}>
                  <p style={styles.codeDescription}>
                    Reproduce this analysis in your own environment. Includes the DiD estimate, event study (parallel trends), placebo test, and visualizations — with all variable selections and controls applied.
                  </p>
